...
time_music = violator_songs[3][1]+violator_songs[-4][1]+violator_songs[-1][1]
print('Три песни звучат ',round(time_music,2),'минут')
...
time_music1 = pocket_universe_songs['On Track']+pocket_universe_songs['To the Sea']+pocket_universe_songs['Beyond Mirrors']
