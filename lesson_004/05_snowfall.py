...
# TODO x,y,length будем получать используя допустим x = sd.random_number(100,1200), y = 600,
...
while True:
    ...
    for index, x in enumerate(snowflakes_x):
        ...
        # TODO Напишем тут сразу если Y < 50 то в списке параметры_снежинок мы по индексу присвоим 700, это потолок!
    sd.sleep(0.05)
